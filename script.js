...
Papa.parse("internet_speeds.csv", {
  ...
  error: function() {
    statusEl.textContent = "❌ Failed to load CSV dataset";
  }
});
...
function buildCharts() {
  ...
  charts.compare = new Chart(document.getElementById("chartCompare"), {
    ...
    options: { ...commonOptions, plugins: { title: { display: true, text: "Selected Country Speed Over Years" } } }
  });
...
// Internet speed vs inequality correlation
